...
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _canContainInline ? 1 : 0).0
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _empty ? 1 : 0).0
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _selfClosing ? 1 : 0).0
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _preserveWhitespace ? 1 : 0).0
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _formList ? 1 : 0).0
//        result = Int.addingReportingOverflow(Int.multipliedReportingOverflow(31, result).0, _formSubmit ? 1 : 0).0
        return result
    }
